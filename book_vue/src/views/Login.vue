    ...
    <div class="login_wrap">
      ...
      <div class="login_item">
        ...
        >
          ...
          <el-form-item label="验证码" prop="svg" class="el_input_book">
            <el-input
              type="password"
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        user_telphone: [{ validator: validateAccount, trigger: "blur" }],
        user_login_password: [{ validator: validatePass, trigger: "blur" }],
      },
    };
  },
  methods: {
